    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            My name is Dima <br/>
            I am <span class="rounded-md text-amber-600">SUPER COOL</span>!
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            I am noob in web-development with 1+ year of experience. <br/>
            I love to learn new things and trying to get better everyday. You can
            <a
