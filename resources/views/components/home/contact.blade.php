	...
	<div class="container">
		<div class="flex flex-wrap lg:justify-between -mx-4">
			<div class="w-full lg:w-1/2 xl:w-6/12 px-4">
				<div class="max-w-[570px] mx-auto mb-12 lg:mb-0">
					<h2 class="text-dark dark:text-gray-100 mb-6 uppercase font-bold text-3xl w-fit mx-auto lg:ml-0 lg:mr-auto">
						Пишите - звоните!
					</h2>
					<p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9 w-fit mx-auto lg:ml-0 lg:mr-auto">
						Всегда рад интересному и продуктивному комьюникейшену!
					</p>
            ...
            <div class="w-full">
              <h4 class="font-bold text-dark dark:text-gray-200 text-xl mb-1">Телефон:</h4>
              <p class="text-base text-body-color dark:text-gray-300">+7 912-696-8836</p>
            </div>
          </div>
					<div class="flex mb-8 max-w-[370px] w-full">
            <div
            ...
            <div class="w-full">
              <h4 class="font-bold text-dark dark:text-gray-200 text-xl mb-1">Где я?</h4>
			...
			<div class="w-full lg:w-1/2 xl:w-5/12 px-4">
				<div class="bg-white dark:bg-slate-900 border-2 border-body-color relative rounded-lg p-8 sm:p-12 shadow-lg">
					...
					>
						...
						@csrf
						<div class="mb-6">
							<x-forms.input placeholder="Ваше имя" name="name" x-model="formData.name"
						...
						<div class="mb-6">
							<x-forms.input type="email" placeholder="Ваш email" name="email" x-model="formData.email"
						...
						<div class="mb-6">
							<x-forms.textarea placeholder="Ваше сообщение" name="message" rows="6" x-model="formData.message"
